							...
							<div class="row">
								<div class="col-sm-12">
									<div class="form-group form-group-default">
										...
										<input name="dnidoc" required="" type="text" class="form-control" maxlength="8" placeholder="Ingrese su No de expediente" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;">
									</div>
								</div>
								...
								<div class="col-md-6">
									<div class="form-group form-group-default">
										...
										<input name="telefo" required="" type="text" class="form-control" maxlength="9" placeholder="Ingrese telefono" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;">
									</div>
								</div>
