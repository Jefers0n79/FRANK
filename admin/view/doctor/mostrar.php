...
<head>
	...
	<title>PANEL ADMINISTRATIVO - MEDICOS</title>
															...
															<tr>
																...
																<td>
																	<div class="form-button-action">
																		...
																		<a href="#editRowModal_<?php echo $va['coddoc']; ?>" title="Editar" data-backdrop="true" class="btn btn-link btn-primary btn-lg" data-toggle="modal"><i class="fa fa-edit"></i></a>

																		<a href="#deleteRowModal<?php echo $va['coddoc']; ?>" title="Eliminar" data-backdrop="true" class="btn btn-link btn-danger btn-lg" data-toggle="modal"><i class="fa fa-trash"></i></a>
																	</div>
																</td>
