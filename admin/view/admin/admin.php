				...
				<div class="page-inner mt--5">
					<div class="row mt--2">
						<div class="col-md-6">
							<div class="card full-height">
								<div class="card-body">
									<div class="card-title" style="color:rgb(42,42,42);"><b>Resumen</b></div>
					...
					<div class="row">
						<div class="col-md-4">
							<div class="card">
								<div class="card-body">
									<div class="card-title fw-mediumbold" style="color:rgb(42,42,42);"><b>Nuevos Pacientes</b></div>
									<?php
									function connect()
									{
											...
											<div class="card-list">
												...
												<div class="item-list">
													...
													<div class="info-user ml-3">
														...
														<div class="status" style="color:rgb(42,42,42);">Paciente</div>
													</div>
						...
						<div class="col-md-4">
							<div class="card">
								<div class="card-body">
									<div class="card-title fw-mediumbold" style="color:rgb(42,42,42);"><b>Nuevos Doctores</b></div>
									<?php
											...
											<div class="card-list">
												...
												<div class="item-list">
													...
													<div class="info-user ml-3">
														...
														<div class="status" style="color:rgb(42,42,42);">Doctor</div>
													</div>
						...
						<div class="col-md-4">
							<div class="card">
								<div class="card-body">
									<div class="card-title fw-mediumbold" style="color:rgb(42,42,42);"><b>Nuevas Especialidades</b></div>
									<?php
											...
											<div class="card-list">
												...
												<div class="item-list">
													...
													<div class="info-user ml-3">
														...
														<div class="status" style="color:rgb(42,42,42);">Especialidad</div>
													</div>
